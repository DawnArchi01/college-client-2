...
export default function AdminHome({ userData }) {
  ...
  useEffect(() => {
    fetch("https://college-server-2.onrender.com/getAllUser", {
      method: "GET",
    })
      .then((res) => res.json())
      .then((data) => {
  ...
  const logOut = () => {
    ...
    window.location.href = "https://college-server-2.onrender.com/sign-in";
  };

  const showPdf = (pdf) => {
    window.open(`https://college-server-2.onrender.com/files/${pdf}`, "_blank", "norefferer");
  };
